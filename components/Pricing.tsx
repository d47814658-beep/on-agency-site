    ...
    <Section id="pricing">
      <div ref={containerRef} className="max-w-lg mx-auto flex flex-col items-center">
        ...
        <MotionDiv 
          ...
          className="w-full relative bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl rounded-[32px] p-6 md:p-12 shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden hover:shadow-[0_0_50px_-12px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_0_50px_-12px_rgba(255,255,255,0.2)] hover:border-gray-300 dark:hover:border-neutral-500 transition-all duration-500"
        >
