    ...
    <Section id="services" className="bg-[#F5F5F7] dark:bg-[#0a0a0a] transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <MotionDiv 
            whileHover={{ y: -5 }}
            className="md:col-span-5 bg-white dark:bg-neutral-900 rounded-[2rem] p-8 md:p-10 shadow-sm border border-gray-100 dark:border-neutral-800 flex flex-col justify-between overflow-hidden min-h-[400px]"
          >
          ...
          <MotionDiv 
            whileHover={{ y: -5 }}
            className="md:col-span-7 bg-white dark:bg-neutral-900 rounded-[2rem] p-8 md:p-10 shadow-sm border border-gray-100 dark:border-neutral-800 flex flex-col justify-between overflow-hidden min-h-[400px]"
          >
          ...
          <MotionDiv 
             whileHover={{ y: -5 }}
             className="md:col-span-4 bg-white dark:bg-neutral-900 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-neutral-800 flex flex-col min-h-[280px]"
          >
          ...
          <MotionDiv 
             whileHover={{ y: -5 }}
             className="md:col-span-4 bg-black dark:bg-white rounded-[2rem] p-8 shadow-xl flex flex-col min-h-[280px] relative overflow-hidden"
          >
