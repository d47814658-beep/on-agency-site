...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 md:px-12 overflow-hidden min-h-[90vh] flex flex-col justify-center items-center text-center bg-[#F5F5F7]">
      
      {/* --- Ambient Background Ripples/Glow (Loop) --- */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        {/* Center Glow */}
        <div className="absolute w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-white rounded-full blur-3xl opacity-80 z-0 animate-float"></div>
        ...
        {[1, 2, 3, 4].map((i) => (
          <MotionDiv
            ...
            className="absolute border border-gray-300 rounded-full z-0"
          />
        ))}
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center max-w-5xl mx-auto w-full">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
            ...
            <MotionDiv 
              ...
              className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-b from-[#1a1a1a] to-black rounded-full flex items-center justify-center shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] text-white relative overflow-hidden group border border-gray-800 flex-shrink-0 transform transition-transform duration-700 hover:scale-105 hover:rotate-3"
            >
               <div className="absolute top-0 inset-x-0 h-1/2 bg-gradient-to-b from-white/20 to-transparent opacity-60 rounded-t-full"></div>
               <svg viewBox="0 0 55 29" className="w-8 md:w-12 text-white fill-current relative z-10">
            ...
            <div className="flex flex-col items-center md:items-start" key={language}>
              <TextEffect 
                ...
                preset='fade' 
                delay={0.5}
                className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-black text-center md:text-left leading-[1.1]"
        ...
        <MotionP 
          ...
          className="text-base md:text-xl text-gray-500 max-w-2xl mb-10 md:mb-12 font-medium leading-relaxed px-4"
        >
